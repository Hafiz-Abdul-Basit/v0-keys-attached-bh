...
export default function Home() {
  ...
  return (
      ...
      <div className="border-b bg-card p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Dialog.Root open={showPlaceholderManager} onOpenChange={setShowPlaceholderManager}>
    ...
    overflow-y-auto space-y-6 z-[200]"
                  ...
                  <div className="space-y-6">
                    {uniqueUnmatchedKeys.length > 0 && (
                      <div className="space-y-4">
                        <div>
                          <h4 className="font-medium text-sm mb-2">Unmatched Keys Found in Documents:</h4>
                          <p className="text-xs text-gray-500 mb-3">
                            These keys were found in your documents but don&apos;t match any known placeholders. Map
                            them to the correct placeholder format.
                          </p>
                        </div>
                        <div className="flex items-center gap-2 mb-4">
                          <Checkbox.Root
                            id="select-all"
                            checked={selectedUnmatched.length === uniqueUnmatchedKeys.length}
                            onCheckedChange={(checked) => {
                              setSelectedUnmatched(checked ? [...uniqueUnmatchedKeys] : [])
                            }}
                        ...
                        <div className="grid gap-4">
                          {uniqueUnmatchedKeys
                            .filter((key) => customPlaceholders[key] !== undefined)
                            .map((key) => (
                              <div
                                key={key}
                              ...
                              >
                                ...
                                <div className="flex-1 grid grid-cols-2 gap-4">
                                  <div>
                                    <Label htmlFor={`key-${key}`} className="text-xs text-gray-500 mb-1 block">
                                      Key found in document:
                                    </Label>
                                    <div className="text-sm font-mono bg-white p-2 rounded break-words">{key}</div>
                                  </div>
                                  <div>
                                    <Label htmlFor={`value-${key}`} className="text-xs text-gray-500 mb-1 block">
                                      Map to placeholder:
                                    </Label>
                                    <Input
                                      id={`value-${key}`}
                        ...
                        <Button
                          onClick={() => {
                            ...
                            if (removedCount > 0) {
                              ...
                              setSelectedUnmatched((prev) => prev.filter((key) => newCustom[key] !== undefined))
                              alert(`Removed ${removedCount} unselected key(s)`)
                            } else {
                              alert("No unselected keys to remove")
                            }
                            console.log(`Removed ${removedCount} unselected key(s)`, {
                              newCustom,
                              newSelectedUnmatched: selectedUnmatched.filter((key) => newCustom[key] !== undefined),
                            })
                          }}
                          variant="destructive"
                    ...
                    <div className="border-t pt-4 space-y-3">
                      ...
                      <div className="grid grid-cols-5 gap-3 items-end">
                        <div className="col-span-2">
                          <Label htmlFor="new-key" className="text-xs text-gray-500 mb-1 block">
                            Key found in document:
                          </Label>
                          <Input
                            id="new-key"
                        ...
                        <div className="col-span-2">
                          <Label htmlFor="new-value" className="text-xs text-gray-500 mb-1 block">
                            Map to placeholder:
                          </Label>
                          <Input
                            id="new-value"
      ...
      {/* Footer with credit - pushed to bottom */}
      <footer className="mt-auto border-t bg-card/50 p-4 text-center text-xs text-muted-foreground">
        <p className="font-semibold">
          Developed by <span className="font-bold text-foreground">Abdul Basit</span>
        </p>
      </footer>
    </div>
  )
